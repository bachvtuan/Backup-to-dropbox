...
BACKUP_CODE="/var/www/Backup-to-dropbox"
BACKUP_CONFIG_FILE="/var/www/Backup-to-dropbox/configs/your_domain_config.json"
...
python backup.py $BACKUP_CONFIG_FILE $BACKUP_FILE_PATH
